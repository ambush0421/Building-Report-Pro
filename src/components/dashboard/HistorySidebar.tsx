...
import { FolderOpen, History, Trash2, Building2 } from "lucide-react";
    ...
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="p-6 border-t border-gray-100 bg-zinc-50/50">
        <div className="flex items-center justify-between opacity-50">
          <span className="text-[10px] font-black uppercase tracking-tighter text-zinc-400">BuildingReportPro</span>
